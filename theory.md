...
Например если мы предсказываем стоиомть кавртиры, то это будет задача регрессии.
...
Если больше двух, то это многоклассовая классиификация.  
...
Например мы хтим разбить фильмы по жанрам и мы не знаем какие у нас жанры есть, мы хотим понять чем они отличаются друг от друга и на какое количество кластеров их хорошо разбить.
